...
import { registerUser, activateUser, logoutUser, loginUser, updateAccessToken, getUserInfo, socialAuth, updateUserInfo, updateUserPassword, updateProfilePicture } from '../controllers/user.controller';
